...
namespace Interfaces
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ALERANDO AQUI
            RentalService rentalService = new RentalService(hour, day, new BrazilTaxServices());//instanciando o sevico de aluguel
            //passando a dependencia que eu quero, que sera classe concreta BrazilTaxServices (BrazilTaxService casando com ITaxService do construtor(upcasting)
